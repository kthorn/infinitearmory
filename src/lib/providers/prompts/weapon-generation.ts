...
- Damage dice MUST use standard die sizes only: d4, d6, d8, d10, or d12. Maximum damage is 12d12. No other die sizes (no d20, d100, d1000000, etc).
- ${rarityInstruction}
...
- Damage dice MUST use standard die sizes only: d4, d6, d8, d10, or d12. Maximum damage is 12d12. No other die sizes.
- ${rarityInstruction}
...
- Damage dice MUST use standard die sizes only: d4, d6, d8, d10, or d12. Maximum damage per weapon is 12d12. No other die sizes.
...
- Damage dice MUST use standard die sizes only: d4, d6, d8, d10, or d12. Maximum damage is 12d12. No other die sizes. If the user requests damage beyond this cap, use 12d12 and note the limit.
